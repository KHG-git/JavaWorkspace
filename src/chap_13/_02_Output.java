...
//        System.out.prtinf();
        ...
        System.out.printf("%6d%n", 1234); //  __1234  ( 6자리 공간을 확보하고 나서 1234 출력)
        System.out.printf("%06d%n", 1234); // 001234  ( 6자리의 공간 확보후 1234 출력 빈 공간은 0으로 채움)
        System.out.printf("%6d%n", -1234); // _-1234
        System.out.printf("%+6d%n", 1234);  //_+1234
        System.out.printf("%,15d%n", 1000000000); // __1,000,000,000
        System.out.printf("%-6d%n", 1234); // 1234__(6자리 공간을 확보하고나서 왼쪽 정렬 1234)
        ...
        System.out.printf("%6s%n","Java"); // __Java (6자리 고간 확보 우측 정렬)
        System.out.printf("%-6s%n", "Java"); // Java__ (6자리 공간 확보하고 좌측 정렬)
        System.out.printf("%6.2s%n", "Java"); // ____Ja (6자리 공간 확보하고 우측 정렬, 2글자만 출력)
        ...
        System.out.printf("%-6s %4d %4d %6.1f %n", "채치수", 96, 100, 97.5);
